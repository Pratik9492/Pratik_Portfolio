...
openMail(): void {
  ...
  const body = encodeURIComponent("Hi Pratik,\n\nI’d love to connect with you regarding...");
  window.location.href = `mailto:prtiknemade@gmail.com?subject=${subject}&body=${body}`;
   window.location.href = 'mailto:prtiknemade@gmail.com';
}
